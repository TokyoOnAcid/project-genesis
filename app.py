...
with tab1:
    ...
    st.markdown("""
    <div class="glow-box">
    Cette vidéo montre une interaction réelle avec le noyau GENESIS.
...
with tab2:
    ...
    with col_text:
        ...
        **Project Genesis change le paradigme.**
...
with tab4:
    ...
    with col_pro:
        ...
        st.markdown("Intégrez le moteur Genesis dans vos jeux ou simulations.")
